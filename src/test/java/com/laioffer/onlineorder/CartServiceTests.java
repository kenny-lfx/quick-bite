...
public class CartServiceTests {
    ...
    void getCart_shouldReturnCartDto() {
        ...
        List<OrderItemEntity> orderItems = List.of(new OrderItemEntity(1L, 1L, cartId, 10.0, 1), new OrderItemEntity(2L, 2L, cartId, 10.0, 2));
        List<MenuItemEntity> menuItems = List.of(new MenuItemEntity(1L, 1L, "Name1", "", 1.0, ""), new MenuItemEntity(2L, 1L, "Name2", "", 10.0, ""));
